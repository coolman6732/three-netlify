                ...
                <dd id='About' className={`${styles.row1} ${styles.ddBg} scroll-target `}>
                    <div className={styles.inner}>
                        <div className={styles.left}>
                            ...
                            <p className={styles.info}>ARIEL 艾瑞爾攜手一支堅強的經營團隊，秉持熱情、效率、品質、服務四大核心價值，致力於打造卓越的客服與社群互動，為玩家帶來前所未有的遊戲體驗。我們用心傾聽每一位玩家的需求，並持續精進，只為成為您最信賴的夥伴。未來，我們將不斷努力，與玩家攜手共創更多精彩時刻，共同邁向成長的每一步。ARIEL 艾瑞爾，讓遊戲不僅是娛樂，更是情感與熱情的延伸。</p>
                        </div>
                    </div>
                </dd>
                ...
                <dd id='Target' className={`${styles.row2} ${styles.ddBg} scroll-target `}>
                    <div className={styles.inner}>
                        <div className={styles.left}>
                            ...
                            <p className={styles.info}>將高品質的海外遊戲帶入玩家的手中是艾瑞爾的初衷，我們致力於挑選最優秀的遊戲作品，提供給玩家前所未有的體驗。而除了深耕代理遊戲的領域，我們也期待在未來能自主開發出更多不僅屬於艾瑞爾，更屬於台灣的遊戲，展現台灣的創意與實力。透過與玩家攜手合作，我們將共同建造屬於大家的遊戲新世紀，為台灣遊戲產業開創全新篇章。</p>
                        </div>
                    </div>
                </dd>
